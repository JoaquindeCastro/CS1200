...
\textbf{Collaborators and External Resources: }I worked on this PSET with Yara on this problem set. We shared our initial ideas about how to approach each problem and late helped each other work through some questions. She shared with me her thinking on what to sort for in problem 1a and that Lemma 3.5 is key to problem 2, while I corrected her understanding of what select() does and helped identify the mistake in the code. We nonetheless wrote our answers individually and tried the problems ourselves before discussing. 
I also wrote part of 3 initially on a whiteboard, and to save time I asked ChatGPT to convert this to LaTeX. The thread of this for proof is below.
