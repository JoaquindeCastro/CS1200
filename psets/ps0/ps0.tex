...
\textbf{Collaborators and External Resources:} None
...
Given a vertex v, the program recursively runs on the children of the input vertex, with an input vertex with no children returning 1. This effectively counts all of the vertices, and each vertex is taken as an input to the function exactly once, the run-time of this function is just the number of vertices.
